...
class TzEvk2Imx636Esp : public TzPseeVideo,
                        public TzIssdDevice,
                        public TemperatureProvider,
                        public IlluminationProvider {
public:
    TzEvk2Imx636Esp(std::shared_ptr<TzLibUSBBoardCommand> cmd, uint32_t dev_id, std::shared_ptr<TzDevice> parent);
    virtual ~TzEvk2Imx636Esp();
