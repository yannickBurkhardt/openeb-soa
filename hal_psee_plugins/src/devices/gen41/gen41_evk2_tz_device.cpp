...
std::string TzEvk2Gen41::ROOT_PREFIX   = "PSEE/";
std::string TzEvk2Gen41::SENSOR_PREFIX = "SENSOR_IF/GEN41/";
...
std::shared_ptr<TzDevice> TzEvk2Gen41::build(std::shared_ptr<TzLibUSBBoardCommand> cmd, uint32_t dev_id,
